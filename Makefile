...
SRC = minishell.c libft/ft_atoll.c libft/ft_putchar_fd.c libft/ft_putendl_fd.c libft/ft_putstr_fd.c libft/ft_split.c \
		...
		parsing/free_parsing.c parsing/lexer_tools.c parsing/anti_leaks.c parsing/init_parsing.c parsing/lexer.c  \
        parsing/parsing.c parsing/parsing_tools.c parsing/syntaxe_checker.c parsing/lexer_utils.c exection/redirection.c exection/open_file.c parsing/config_mini.c \
